...
if __name__ == "__main__":
    ...
    parser.add_argument('--source_images', type=str, help='Path to folder containing images', default ='./src_images/FRGC_MTCNN')
    parser.add_argument('--output', type=str, help='Path to output folder', default ='./out_images/self_FRGC')
